...
non <- read.csv(file.path(out_dir, 'rerun2026_nonresponder_all_standardized.csv'), check.names = FALSE)
...
# outputs
write.csv(age_table, file.path(out_dir, 'rerun2026_analysis2_all512_age_numeric_test.csv'), row.names = FALSE)
write.csv(core_tests_df, file.path(out_dir, 'rerun2026_analysis2_all512_categorical_tests.csv'), row.names = FALSE)
write.csv(core_levels_df, file.path(out_dir, 'rerun2026_analysis2_all512_categorical_levels.csv'), row.names = FALSE)
write.csv(training_df, file.path(out_dir, 'rerun2026_analysis2_all512_training_checkbox_tests.csv'), row.names = FALSE)
write.csv(barrier_df, file.path(out_dir, 'rerun2026_analysis2_all512_barrier_checkbox_tests.csv'), row.names = FALSE)
write.csv(conf_df, file.path(out_dir, 'rerun2026_analysis2_all512_confidence_item_tests.csv'), row.names = FALSE)
write.csv(conf_overall, file.path(out_dir, 'rerun2026_analysis2_all512_confidence_overall_test.csv'), row.names = FALSE)
write.csv(knowledge_num, file.path(out_dir, 'rerun2026_analysis2_all512_knowledge_numeric_tests.csv'), row.names = FALSE)
write.csv(state, file.path(out_dir, 'rerun2026_analysis2_all512_state_completion_table.csv'), row.names = FALSE)
write.csv(state_top_completers, file.path(out_dir, 'rerun2026_analysis2_all512_state_top_completers.csv'), row.names = FALSE)
write.csv(state_no_matched, file.path(out_dir, 'rerun2026_analysis2_all512_state_no_matched_cases.csv'), row.names = FALSE)
write.csv(state_extremes, file.path(out_dir, 'rerun2026_analysis2_all512_state_rate_extremes_n_ge_10.csv'), row.names = FALSE)
write.csv(state_counts_summary, file.path(out_dir, 'rerun2026_analysis2_all512_state_counts_summary.csv'), row.names = FALSE)
...
summary_lines <- c(
  ...
  sprintf('Non-responders (all set): %d', nrow(non)),
...
writeLines(summary_lines, file.path(out_dir, 'rerun2026_analysis2_all512_summary.txt'))

html <- paste0(
  '<html><body style="font-family: Helvetica, Arial, sans-serif;">',
  '<h1>Analysis 1 Full: Responder 362 vs All Non-Responders 512</h1>',
  '<p>Date: ', Sys.Date(), '</p>',
  '<p>Non-responder set rule: all pre-assessment entries not in the colleague matched responder set.</p>',
  '<p>Sample sizes: responders n=362; non-responders n=512.</p>',
...
writeLines(html, file.path(out_dir, 'rerun2026_analysis2_all512_report.html'))
